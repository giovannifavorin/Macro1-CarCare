        ...
        CarViewModel(car: .init(title: "GOL", img: "Gol", categories: [
            .init(title: "Motor", infos: [
                .init(title: "Combustível", description: [
                    ...
                    .init(title: "Óleo", description: [
                        .init(title: "Como saber o nível?", descriptionTips: [" Analisando o nível do óleo na vareta, você pode encontrar indícios se está na hora de trocar o óleo ou não, o óleo deve estar entre os dois pontos de medição"]),
